...
Windows.setText(findWindowsObject('Object Repository/LabDB/Edit(1)'), 'Vaibhav')

Windows.setText(findWindowsObject('Object Repository/LabDB/Edit(2)'), '8857362882')

Windows.setText(findWindowsObject('Object Repository/LabDB/Edit(3)'), 'Cancer')
